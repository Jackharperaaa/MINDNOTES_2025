...
import { Send, Bot, User, Sparkles, LogIn } from 'lucide-react'; // Adicionado LogIn icon
      ...
      {user ? (
        ...
        <div className="flex flex-col items-center justify-center flex-1 text-center p-4">
          ...
          <h3 className="text-2xl font-bold text-foreground mb-3">
            Conecte-se para usar o Chat AI
          </h3>
          <p className="text-muted-foreground mb-8 max-w-md">
            Faça login com sua conta Google para organizar suas ideias com a ajuda da inteligência artificial.
          </p>
          <Button 
